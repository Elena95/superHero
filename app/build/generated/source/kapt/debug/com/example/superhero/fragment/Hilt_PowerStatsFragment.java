 ...
 */
public abstract class Hilt_PowerStatsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_PowerStatsFragment() {
    super();
  }

  Hilt_PowerStatsFragment(int arg0) {
    super(arg0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PowerStatsFragment_GeneratedInjector) this.generatedComponent()).injectPowerStatsFragment(UnsafeCasts.<PowerStatsFragment>unsafeCast(this));
    }
  }
