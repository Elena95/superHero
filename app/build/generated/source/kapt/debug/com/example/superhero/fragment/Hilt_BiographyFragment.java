 ...
 */
public abstract class Hilt_BiographyFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_BiographyFragment() {
    super();
  }

  Hilt_BiographyFragment(int arg0) {
    super(arg0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((BiographyFragment_GeneratedInjector) this.generatedComponent()).injectBiographyFragment(UnsafeCasts.<BiographyFragment>unsafeCast(this));
    }
  }
