 ...
 */
public abstract class Hilt_AppearanceFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AppearanceFragment() {
    super();
  }

  Hilt_AppearanceFragment(int arg0) {
    super(arg0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AppearanceFragment_GeneratedInjector) this.generatedComponent()).injectAppearanceFragment(UnsafeCasts.<AppearanceFragment>unsafeCast(this));
    }
  }
