 ...
 */
public abstract class Hilt_SuperHeroFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_SuperHeroFragment() {
    super();
  }

  Hilt_SuperHeroFragment(int arg0) {
    super(arg0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SuperHeroFragment_GeneratedInjector) this.generatedComponent()).injectSuperHeroFragment(UnsafeCasts.<SuperHeroFragment>unsafeCast(this));
    }
  }
