 ...
 */
public abstract class Hilt_ConnectionsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ConnectionsFragment(int arg0) {
    super(arg0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ConnectionsFragment_GeneratedInjector) this.generatedComponent()).injectConnectionsFragment(UnsafeCasts.<ConnectionsFragment>unsafeCast(this));
    }
  }
